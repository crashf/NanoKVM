  ...
  translation: {
    ...
    settings: {
      ...
      wireguard: {
        ...
        package: '安装包',
        unzip: '并解压',
        upWireguard: '将 wireguard-go 文件上传到 /usr/bin/ 目录',
        upWg: '将 wg 文件上传到 /usr/bin/ 目录',
        upWgQuick: '将 wg-quick 文件上传到 /usr/bin/ 目录',
        manualInstall1: '下载 RISC-V 架构的 wireguard-go、wg 和 wg-quick 二进制文件',
        manualInstall2: '将 wireguard-go、wg 和 wg-quick 上传到 /usr/bin/ 目录',
        manualInstall3: '运行：chmod +x /usr/bin/wireguard-go /usr/bin/wg /usr/bin/wg-quick',
        refresh: '刷新页面',
        start: '确定要启动 WireGuard 吗？',
        restart: '确定要重启 WireGuard 吗？',
        stop: '确定要停止 WireGuard 吗？',
        stopDesc: '停止 WireGuard VPN 连接。',
        uninstall: '卸载',
        uninstallConfirm: '确定要卸载 WireGuard 吗？',
        uninstallDesc: '确定要卸载 WireGuard 吗？',
        up: '启动',
        down: '停止',
        okBtn: '确认',
        cancelBtn: '取消',
        ...
        status: {
          title: '连接状态',
          notConfigured: 'WireGuard 尚未配置，请在配置选项卡中进行配置。',
          interface: '网络接口',
          status: '状态',
          running: '运行中',
          stopped: '已停止',
        ...
        config: {
          title: '配置',
          description: '编辑您的 WireGuard 配置文件',
          placeholder: '在此粘贴您的 WireGuard 配置...',
          save: '保存配置',
          saveConfig: '保存',
          saving: '保存中...',
          saved: '配置已成功保存',
          ...
          interface: '网络接口',
          configHelp: '在下方编辑您的 WireGuard 配置。点击"加载模板"获取入门配置。',
          template: {
            title: '配置模板',
            description: '使用此模板开始配置 WireGuard',
            interface: '[Interface]',
            address: 'Address = 10.0.0.2/24',
            privateKeyComment: '# 替换为您的私钥',
            privateKeyPlaceholder: 'PrivateKey = YOUR_PRIVATE_KEY_HERE',
            peer: '[Peer]',
            publicKeyComment: '# 替换为服务器公钥',
            publicKeyPlaceholder: 'PublicKey = SERVER_PUBLIC_KEY_HERE',
            endpointComment: '# 替换为您的服务器地址和端口',
            endpointPlaceholder: 'Endpoint = your-server.com:51820',
            allowedIPsComment: '# 通过 VPN 路由所有流量',
          ...
          validation: {
            empty: '配置不能为空',
            invalid: '配置格式无效',
            missingInterface: '缺少 [Interface] 部分',
            missingPrivateKey: '[Interface] 部分缺少 PrivateKey',
            error: '配置错误'
          }
        }
      },
