  ...
  translation: {
    ...
    settings: {
      ...
      wireguard: {
        ...
        startDesc: 'Start the WireGuard VPN connection.',
        restart: 'Restart WireGuard?',
        restartDesc: 'Restart the WireGuard VPN connection.',
        stop: 'Stop WireGuard?',
        ...
        status: {
          ...
          started: 'WireGuard started successfully',
          stoppedSuccess: 'WireGuard stopped successfully',
          restarted: 'WireGuard restarted successfully',
          startFailed: 'Failed to start WireGuard',
          stopFailed: 'Failed to stop WireGuard',
          restartFailed: 'Failed to restart WireGuard',
        ...
        config: {
          ...
          loadTemplateDesc: 'This will replace your current configuration. Continue?',
          ...
          fileUploaded: 'Configuration file uploaded successfully',
          uploadFailed: 'Failed to upload configuration file',
          empty: 'Configuration cannot be empty',
          loadFailed: 'Failed to load configuration',
          saveFailed: 'Failed to save configuration',
          generateFailed: 'Failed to generate keys',
          generatedKeys: 'Generated WireGuard Keys',
          generateKeysDesc: 'Generate a new WireGuard key pair?',
          copyKeys: 'Copy these keys to your configuration.',
          quickStart: 'Quick Start Guide',
          step1: 'Generate a key pair using the "Generate Keys" button',
          step2: 'Get your WireGuard server config (public key, endpoint, allowed IPs)',
          step3: 'Paste or upload your configuration, or use the template',
          step4: 'Save the configuration and start WireGuard from the Status tab',
          template: {
