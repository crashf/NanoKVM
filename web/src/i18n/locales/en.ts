  ...
  translation: {
    ...
    settings: {
      ...
      wireguard: {
        ...
        package: 'installation package',
        unzip: 'and unzip it',
        upWireguard: 'Upload wireguard-go to NanoKVM directory /usr/bin/',
        upWg: 'Upload wg to NanoKVM directory /usr/bin/',
        upWgQuick: 'Upload wg-quick to NanoKVM directory /usr/bin/',
        manualInstall1: 'Download wireguard-go, wg, and wg-quick binaries for RISC-V',
        manualInstall2: 'Upload wireguard-go, wg, and wg-quick to /usr/bin/ directory',
        manualInstall3: 'Run: chmod +x /usr/bin/wireguard-go /usr/bin/wg /usr/bin/wg-quick',
        refresh: 'Refresh current page',
        start: 'Start WireGuard?',
        restart: 'Restart WireGuard?',
        stop: 'Stop WireGuard?',
        stopDesc: 'Stop the WireGuard VPN connection.',
        uninstall: 'Uninstall',
        uninstallConfirm: 'Uninstall WireGuard?',
        uninstallDesc: 'Are you sure you want to uninstall WireGuard?',
        up: 'Bring Up',
        down: 'Bring Down',
        okBtn: 'Yes',
        cancelBtn: 'No',
        ...
        status: {
          ...
          notConfigured: 'WireGuard is not configured. Please configure it in the Configuration tab.',
          interface: 'Interface',
          status: 'Status',
          running: 'Running',
          stopped: 'Stopped',
        ...
        config: {
          title: 'Configuration',
          description: 'Edit your WireGuard configuration file',
          ...
          generated: 'Keys generated successfully',
          ...
          interface: 'Interface',
          configHelp: 'Edit your WireGuard configuration below. Click "Load Template" for a starter configuration.',
          template: {
            title: 'Configuration Template',
            description: 'Use this template to get started with WireGuard',
            interface: '[Interface]',
            address: 'Address = 10.0.0.2/24',
            privateKeyComment: '# Replace with your private key',
            privateKeyPlaceholder: 'PrivateKey = YOUR_PRIVATE_KEY_HERE',
            peer: '[Peer]',
            publicKeyComment: '# Replace with server public key',
            publicKeyPlaceholder: 'PublicKey = SERVER_PUBLIC_KEY_HERE',
            endpointComment: '# Replace with your server address and port',
            endpointPlaceholder: 'Endpoint = your-server.com:51820',
            allowedIPsComment: '# Route all traffic through VPN',
            allowedIPs: 'AllowedIPs = 0.0.0.0/0',
            persistentKeepalive: 'PersistentKeepalive = 25'
          },
          validation: {
            empty: 'Configuration cannot be empty',
            invalid: 'Invalid configuration format',
            missingInterface: 'Missing [Interface] section',
            missingPrivateKey: 'Missing PrivateKey in [Interface] section',
